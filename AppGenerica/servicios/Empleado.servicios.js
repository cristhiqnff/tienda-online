...
async function eliminarEmpleado(id) {
  ...
  try {
    ...
    const [rows] = await conn.execute("DELETE FROM empleado WHERE id_empleado = ?", [id]);
...
async function eliminarRolEmpleado(id) {
  const [rows] = await db.execute("DELETE FROM rol_empleado WHERE id_rol_empleado = ?", [id]);
  return rows.affectedRows;
}
...
async function eliminarPerfil(id) {
  const [rows] = await db.execute("DELETE FROM perfil WHERE id_perfil = ?", [id]);
  return rows.affectedRows;
}
...
async function eliminarMenuOpcion(id) {
  const [rows] = await db.execute("DELETE FROM menu_navegacion WHERE id_menu = ?", [id]);
  return rows.affectedRows;
}
...
async function eliminarPermiso(id) {
  const [rows] = await db.execute("DELETE FROM permiso_perfil_menu WHERE id_permiso = ?", [id]);
  return rows.affectedRows;
}
